...
def apoyoAreaOperativa Mile y maga, john, laura
...
comprar en sitios que puedan certificar, que el tendero firme con cedula y teléfono
transporte de donde a donde, firma cédula, nombre
control de asistencia! y ¿porqué no asistió a clase?
el chaleco! escarapela!
Correo a milena
Nombre Completo
Número de cédula
RH
...
Tenemos seguro, pensión, ARL
informe estadísticas
tomar fotos de los talleres  Lugar Fecha y Evento
Manual de procesos
...
def OJO integrar como técnica las señas para el ensamble repentino
exec como hacer  que las electrónicas ayuden a iniciar otras casas, orff, dani pedro
...
/op exec Repertorios para 1 para 2 para  4
/op def ?Asociacion con la usm Agremiación - Legalidad sayco .. comunicaciones
exec cuandrar con marta empaque de cosas (canecas)
def cada linder queda encargado de coordinar sus sets de instrumento
def enlaces de escuelas (conectores)
...
exec cada uno escoge una sede temporal para experimntar lo que sería su casa-

# Conectores
/conect exec averiguar laso que fueron a la conferecia de electrönica.
exec la bola .. y pajaro de monte las propones claudia para aprender


# Comunicacion
try en ensamble medellin vive la música + semilleros gran gente!
def compartir lo mismo con presentacion diferente
def estrategia comunicacion talleres
ecard jpg
integrar la inscripción por facebook

# Desarrollos
exec como replicar en masa el secuenciador?
exec taller de literatura
